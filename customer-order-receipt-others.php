...
<section class="bakers" style="margin: 0 auto">
    <div class="container">
        <div class="global-headline">
            ...
            <div class="container">
                <div class="row">
                    <div class='description animate-left'><div>
                            ...
                            echo "<div class='description-title text-center' style='text-indent: 1%;'><p></p></div>
            ...
            $count = 0;
            echo "<div class='description-title text-center animate-right' style='text-indent: 1%;'><p>Order Information</p></div><br>";
